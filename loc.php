...
<head>
  ...
  <script>        
    function timkiem(str){
        var xmlhttp;
        if(str==""){
            document.getElementById("timkiem1").innerHTML="";
            return false;
        }
        ...
        xmlhttp.onreadystatechange=function(){
            if(this.readyState==4 && this.status==200){
                document.getElementById("timkiemtb").innerHTML=this.responseText;
            }
        }
        xmlhttp.open("GET","timkiem.php?timtu="+str,true);
        xmlhttp.send();
    }
...
<br>
    <input type="text" name="timtu" placeholder="tìm kiếm...">
...
<div id="scrolling">
        ...
        if(isset($_GET['tenmon'])){
          $tenmon=$_GET['tenmon'];
          

        $sql="SELECT * FROM cauhoi WHERE chude='$tenmon' AND noidungcauhoi LIKE '%$timtu%'";
        ...
        <?php
            ...
            $sql1="select * from cauhoi where chude='$tenmon' order by id DESC"; 
        ...
        echo"
        <p style='color:#800000; font-weight:bold; text-align:center; margin-top:10px'>Chưa có câu hỏi của chủ đề này</p>";
    }
      }
        ?>
    </div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <img style="width:195px; height: 200px;" src="ctu.png" alt="Panther">
                  </div>
                  <div class="carousel-item">
                     <img style="width:195px; height: 200px;" src="cit.jpg" alt="Black Cat">
                  </div>
                  <div class="carousel-item">
                     <img style="width:195px; height: 200px;" src="doan.jpg" alt="Lion">
                  </div>
               </div>
            </div>
